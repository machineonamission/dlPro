!function (e, t) {
    ...
    var t, s = {};
    e.r(s), e.d(s, {FFFSType: () => n, FFmpeg: () => i}), function (e) {
    ...
    class i {
        ...
        load = ({
                    classWorkerURL: s,
                    ...r
                } = {}, {signal: a} = {}) => (this.#e || (this.#e = s ? new Worker(new URL(s, "file:///Users/focus/Projects/ffmpeg.wasm/packages/ffmpeg/dist/esm/classes.js"), {type: "classic"}) : new Worker(new URL(e.p + e.u(814), e.b), {type: void 0}), this.#o()), this.#i({
            type: t.LOAD,
            data: r
        }, void 0, a));
        exec = (e, s = -1, {signal: r} = {}) => this.#i({type: t.EXEC, data: {args: e, timeout: s}}, void 0, r);
        ffprobe = (e, s = -1, {signal: r} = {}) => this.#i({type: t.FFPROBE, data: {args: e, timeout: s}}, void 0, r);
        terminate = () => {
